...
class HomeWorkScreen extends GetWidget<HomeWorkScreenController>  {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
          backgroundColor: ColorConstant.blueFC,
          body: Container(
                                    ...
                                    child: ListView.builder(itemCount:4,itemBuilder: (context, index) {
                                      return  Column(
                                        children: [
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  decoration: BoxDecoration(
                                                    ...
                                                    color:
                                                    ColorConstant.blueFC.withOpacity(.4),
                                                  ),
                                                  child: Padding(
                                                ...
                                                Divider(height: 40, color: ColorConstant.blueFC.withOpacity(.4 ), thickness: 1),
                                                Text(
                                          ...
                                          Divider(height: 20, color: ColorConstant.greyF3, thickness: 5),
                                        ],
                                      );
                                    },
