          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Obx(
                  () => controller.leaveDetailsModel.value.docs != null &&
                          controller.leaveDetailsModel.value.docs!.isNotEmpty
                      ? Bounce(
                          onTap: () {
                ...
                Obx(
                  () => AppElevatedButton(
                    ...
                    onPressed: () {
                      controller.getLeaveRemoveApi();
                    },
                    isLoading: controller.isRemoveLoading.value,
                  ),
                )
              ],
            ),
