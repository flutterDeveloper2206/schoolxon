...
//
//     final studentDataModel = studentDataModelFromJson(jsonString);

import 'dart:convert';

StudentDataModel studentDataModelFromJson(String str) =>
    StudentDataModel.fromJson(json.decode(str));

String studentDataModelToJson(StudentDataModel data) =>
