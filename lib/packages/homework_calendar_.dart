...
class HomeWorkCalendar extends StatefulWidget {
  ...
  @override
  State<HomeWorkCalendar> createState() => _HomeWorkCalendarState();
}

class _HomeWorkCalendarState extends State<HomeWorkCalendar> {
